...
<body style="border-color: rgba(33,37,41,0);">
    ...
    <div class="table-responsive" style="background: #ffffff;font-size: 20px;margin: 0px;margin-top: 20px;margin-right: 00;margin-left: 0px;padding-right: 10px;padding-bottom: 0px;padding-left: 10px;">
        <table class="table">
            <thead>
                <tr>
                    <th style="background: #b9e4e1;width: 70px;border: 1px solid #000000 ;">Ward Number</th>
                    <th style="background: #b9e4e1;width: 70px;border: 1px solid #000000 ;">Floor</th>
                    <th style="background: #b9e4e1;width: 70px;border: 1px solid #000000 ;">Type</th>
                    <th style="background: #b9e4e1;width: 70px;border: 1px solid #000000 ;">Number of Beds</th>
                    <th style="background: #b9e4e1;width: 70px;border: 1px solid #000000 ;">Available Beds</th>
                </tr>
            </thead>
